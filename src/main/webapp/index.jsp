...
<div class="login">
    ...
    <div class="login_bg" style="height: 500px;">
        <div>
            ...
            <div id="welcome_navi"><button style="cursor: pointer" onclick="javascrtpt:window.location.href='${path}/index/home'">开启一段奇妙之旅<br/>Let's begin</button><button style="cursor: pointer" onclick="javascrtpt:window.location.href='${path}/admin/loginPre'">管理员登录<br/>Manager Login</button></div>
        </div>
    </div>
</div>

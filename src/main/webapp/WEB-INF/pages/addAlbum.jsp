...
<div class="login no_select">
    <div class="login_bg1">
        <form action="/album/addAlbum" method="post" class="" enctype="multipart/form-data">
            <div style="margin-bottom: 10px;color: #07558c;font-size: 30px;">添加相册：</div>
            <div class="write_textarea_article_content">
                <div style="vertical-align: top;width:30%;display: inline-block;">
                    <input style="background: #D0DDEF;width:100%;margin:auto;border-radius: 10px;font-size: 20px;display: block;" type="text" id="write_textarea_article_title" name="albumname" placeholder="键入相册标题 / Enter Album Title">
                    <textarea style="width:100%;height:380px;border-radius: 10px;font-size: 20px;display: block;" id="write_textarea_article_content" name="albummemo" placeholder="键入相册描述 / Enter Album Memo"></textarea>
                </div>
                <div style="vertical-align: top;width: 40%;display: inline-block;height: 430px;background: #D0DDEF;border-radius: 10px;padding: 10px;">
                    <div style="text-align: left;margin-bottom: 10px;"> 相册封面：</div>
                    <img id="img" style="display: inline-block;border: 4px solid #777777;width: 95%;height: 360px;" src="${path}/static/img/luesuotu.jpg"/>
                </div>
...
<script type="text/javascript">
    ...
    $("#write_textarea_article_title").blur(
        function () {
            $(this).attr("placeholder","键入相册标题 / Enter Album Title")
        }
    )
    ...
    $("#write_textarea_article_content").blur(
        function () {
            $(this).attr("placeholder","键入相册描述 / Enter Album Memo")
        }
    )

...
<div class="content" style="width: 100%">
    <div style="width: 100%;text-align: left;background: rgba(255,255,255,0.6);padding: 10px;border-radius: 10px;display: inline-block;">
        <h1 style="font-family: 黑体;font-size: 50px;text-align: center">${article.title}</h1>
        <h2 style="font-family: RBNo2;font-size: 15px;text-align: center">作者：${writer}</h2>
        <p style="padding: 10%;text-indent:2em;">${article.content}</p>
